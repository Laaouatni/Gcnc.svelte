<script lang="ts">
  import GuiToolsMagazzinoAddButton from "./GuiToolsMagazzinoNavbarButton/GuiToolsMagazzinoAddButton.svelte/GuiToolsMagazzinoAddButton.svelte";
